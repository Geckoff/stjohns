		...
		return this.each(function(){
			...
			if($('.show',slidik).length){
			    ...
			    if($("ul").is("#slide_2")) {
                    ...
                    var hheight = $("ul[class='slidik']").children("li").height();
                    $(".header-content").css("height", hheight + 'px');
                    // sponsors bg position & height
                    var pos = $('.sponsors .inner-content').offset().top;
                    $('.sponsors-bg').css('top', pos + 'px');
                    var h = $('.sponsors .inner-content').height();
                    $('.sponsors-bg').css('height', h + 'px');
			    }
